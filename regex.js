...
// // test whether the str sent to you is valid for currency---------------------NOT DONE YET!!
// function testMoney (str) {
//     var t = /^\$(([0-9]{1,}\,?)?){1,}[0-9]{1,}\.?([0-9]{2})?$/
...
// // test whether the str sent to you is a valid zip code----------------------NOT DONE YET!!!
